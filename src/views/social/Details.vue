            ...
            <el-row>
                <el-col :span="9" style="padding: 0px 10px 20px 0px">
                    ...
                    <div style="padding: 10px">
                        <span style="font-size: 26px;line-height: 40px;font-weight: 600">{{name}}
                            <br>
                        </span>
                        <span style="font-size: 20px;font-style: normal;font-weight: 300;line-height: 35px;color: #666;">{{githubUsername}}
                            <br>
                        </span>
                        <span style="font-size: 14px;line-height: 20px;color:#606266;" v-if="location">
                            <i class="el-icon-location-outline"></i>&nbsp;&nbsp;{{location}}
                            <br>
                        </span>
                        <span style="font-size: 14px;line-height: 20px;color:#606266;" v-if="email">
                            <i class="el-icon-message"></i>&nbsp;&nbsp;{{email}}
                            <br>
                        </span>
                        <span style="font-size: 14px;color:#606266;" v-if="blog">
